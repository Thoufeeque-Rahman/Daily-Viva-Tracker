...
if (!process.env.JWT_SECRET) {
  ...
  process.env.JWT_SECRET =
    "b2e3c059f1cc407f24c4fdfc926d3b33b426888d1b6c55e506cc277098ae5e79"; // Fallback for development
}
...
app.use(
  cors({
    origin: [
      ...
      "https://dailyviva.darulirfan.co.in",
...
app.get("/api/test", (req, res) => {
  res.json({
    message: "API is running with CORS fixes!",
